...
INSERT INTO `sitoo_test_assignment`.`product` 
  ...
  VALUES
  (1, 'sku_1', 10.0, '2019-05-01', '2019-06-03'),
  (2, 'sku_2', 10.0, '2019-05-02', '2019-06-05'),
  (3, 'sku_3', 10.0, '2019-05-03', '2019-06-07'),
  (4, 'sku_4', 15.0, '2019-05-04', '2019-06-12'),
  (5, 'sku_5', 20.0, '2019-05-05', '2019-06-03'),
  (6, 'sku_6', 25.0, '2019-05-06', '2019-06-03'),
  (7, 'sku_7', 30.0, '2019-05-07', '2019-06-04'),
  (8, 'sku_8', 35.0, '2019-05-08', '2019-06-08'),
  (9, 'sku_9', 40.0, '2019-05-09', '2019-06-23'),
  (10, 'sku_10', 45.0, '2019-05-10', '2019-07-10');
